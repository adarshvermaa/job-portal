from .serializer import UserSerializers,UserLoginSerializer,PasswordResetSerializer,EmailVerificationSerializer,LogoutSerializer
...
class LogoutView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response({"detail": "Failed to log out. {}".format(str(e))}, status=status.HTTP_400_BAD_REQUEST)